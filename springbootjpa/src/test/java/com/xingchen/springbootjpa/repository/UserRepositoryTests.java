package com.xingchen.springbootjpa.repository;


import com.xingchen.springbootjpa.model.User;
...
//		userRepository.delete(userRepository.findByUserName("aa"));
    ...
    public void testQuery() {
        ...
        String formattedDate = dateFormat.format(date);
        User user=new User("ff", "ff123456","ff@126.com", "ff",  formattedDate);
        //Assert.assertEquals("ff123456",userRepository.findByNickName("ff").getPassWord());
    }
